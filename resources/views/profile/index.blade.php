           ...
           <div class="col-md-12">
            ...
            <tbody>
              @forelse($forums as $forum)   
               <tr> 
                <td>{{str_limit($forum->title, 40)}} ...<i style="font-size: 10px; color: #999;"> {{$forum->created_at->diffForHumans()}} , {{$forum->comments->count()}} Comments</i>
                 </td>
              ...
              @empty
                <p>Hmmm, sepertinya kamu belum membuat pertanyaan.</p>
              @endforelse
              </tbody>
                  </table>
                  <div class="row justify-content-center">
