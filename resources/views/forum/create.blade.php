...
<div class="container">
     <div class="jumbotron" id="tc_jumbotron">
        <div class="col-md-8 offset-md-2">
          <div class="text-center"><h3 style="color: #fff;">Tanyakan Sesuatu</h3></div><hr style="background: #fff"> 
        </div>
      <div class="row justify-content-center">
        <div class="col-md-9">
            ...
            <div id="screenshot-open" class="collapse">  
             ...
             <button type="submit" class="btn btn-success btn-block">Tanya</button>
               </form>
              </div>
              </div>
           <br>
