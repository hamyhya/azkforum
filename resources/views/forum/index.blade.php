  ...
  <div class="jumbotron" id="tc_jumbotron">
    <div class="card-body" id="xx" style="color: #fff;     border:1px solid #fff;">
        <div class="text-center"> 
           <h1 style="    font-size: 3.5rem;">Azk Forum</h1> 
        <p>Malu Ber-Azk, Sesat Dijalan </p>  
          </div>
        </div> 
      </div> 
    </div>  
        <div class="container"> 
            ...
            <div class="card" id="tc_paneldefault"> 
             ...
             <tr> 
                ...
                <p>{{str_limit ($forum->description, 60)}}</p>
            ...
            <small style="margin-bottom: 0; color: #666">{{$forum->created_at->diffForHumans()}}</small>
             <small>by <a href="{{ route('profile', Auth::user()->name) }}">{{$forum->user->name}}</a></small> 
            </div>
            </td>
            </tr>  
            @endforeach
               ...
               <div class="card">
                ...
                <div class="list-group">
                 @foreach($forums as $asklist)
                 <a href="{{route('forumslug', $asklist->slug)}}" class="list-group-item" id="index_hover">{{str_limit($asklist->title, 40)}}
                @endforeach
                </a> 
                </div>
                </div>
