        ...
        <div class="col-md-12" id="tc_container_wrap">
            ...
            <div class="card-footer link_a">
             ...
             <div id="{{$comment->id}}-collapse1reply" class="card-collapse collapse">
              ...
              <div class="card">
                ...
                @empty
                <p>Yah, belum ada balasan nih. Coba share thread ini untuk mendapat bantuan! ;)</p>
              @endforelse

               </div>
                  <div class="panel-body" style="    border-top: 1px solid #eee;">
                  @guest
                    <a href="{{route('login')}}"><p>Kamu harus login dulu yaa</a></p>
                  @else
              ...
              @empty
                <p>Yah, belum ada bantuan nih. Coba share thread ini untuk mendapat bantuan! ;)</p>
              @endforelse
            <!-- endforelse -->
              <hr>
            ...
            <div class="add_comment">
              <div class="open_comment">
                  <div class="h1"><h4>Beri Bantuan</h4></div>
              </div>
              @if(Auth::guest())
                <div class="comment-show" style="padding: 61px">
                  <a href="{{route('login')}}"><p>Kamu harus login dulu yaa</a></p>
                </div>
              @else
              <div class="comment-show">
                <form action="{{route('addComment', $forums->id)}}" method="post">
                  {{csrf_field()}}
                <div class="form-group">
                  <input type="text" name="content" id="Your-Answer" placeholder="Bantu:" required="required">
                  <label for="Your-Comment">Bantu:</label>    
                </div>
                <div class="button-gg content-justify-right"> 
                  <button style="float:right"class="btn btn-success" type="submit">Kirim Bantuan</button>
                </div>
              </form>
              </div>
              @endif
               ...
               <div class="col-md-4">
                  <a href="{{route('forum.create')}}" class="btn btn-success btn-block">Tanyakan Sesuatu</a><br>
               <div class="card">
                <div class="card-header" style="background: #2ab27b; color: #fff; padding: 8px 1.25rem;">Paling Baru</div>
                <div class="list-group">
                @foreach($shows as $show)
                 <a href="{{route('forumslug', $show->slug)}}" class="list-group-item" id="index_hover">
                {{str_limit($show->title, 40)}}
                </a>
                @endforeach
                </div>
                </div>
